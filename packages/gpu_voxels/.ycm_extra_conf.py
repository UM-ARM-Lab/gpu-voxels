...
#        "_", os.environ.get('HOME') + "/.bashrc"],
#     shell=False, stdout=subprocess.PIPE).communicate()[0]
#     print os.environ.get('HOME') + "/.bashrc"
...
def GetRPGIncludePaths():
    ...
    includes.append('/home/bradsaund/gvl/include')
    includes.append('/usr/include')
    includes.append('/usr/include/eigen3/Eigen')
...
SOURCE_EXTENSIONS = ['.cpp', '.cxx', '.cc', '.c', '.m', '.mm', 'py']
